...
async function handleAssistant(req, res) {
  ...
  if (lower.includes('help') || lower.includes('what can you do') || lower.includes('commands') || lower.includes('guide')) {
    ...
    action = "theme";
    actionArg = "light";
  } else if (lower.includes('large text') || lower.includes('bigger text') || lower.includes('increase font') || lower.includes('a+ large')) {
    reply = "Adjusting font size to large.";
    action = "textSize";
    actionArg = "lg";
  } else if (lower.includes('extra large') || lower.includes('xl text') || lower.includes('maximum text') || lower.includes('a++ xl')) {
    reply = "Adjusting font size to extra large.";
    action = "textSize";
    actionArg = "xl";
  } else if (lower.includes('normal text') || lower.includes('reset text') || lower.includes('default text')) {
    reply = "Resetting font size to normal.";
    action = "textSize";
    actionArg = "normal";
  } else if (lower.includes('high contrast') || lower.includes('more contrast') || lower.includes('toggle contrast')) {
    reply = "Toggling high contrast mode for improved visibility.";
    action = "contrast";
  } else if (lower.includes('read page') || lower.includes('read aloud') || lower.includes('read this page')) {
    reply = "Reading the main sections of the page aloud.";
    action = "readPage";
